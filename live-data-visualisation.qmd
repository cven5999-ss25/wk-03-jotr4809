...
ggplot(data = global_waste_data_kg_year, 
       mapping = aes(x = gdp,
                     y = capita_kg_year, 
                     color = income_id,
                     shape = income_id)) + #agrega colores en base a una variable 
  geom_point() 
```
...
ggplot(data = global_waste_data_kg_year,
       mapping = aes(x = gdp,
                     ...
                     shape = income_id))+
  geom_point() + 
  scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(0, 1400)) + #c es de combine 
  scale_x_log10(labels = scales::label_log()) # los :: son para llamar funciones de una misma libreria 
```
...
ggplot(data = global_waste_data_kg_year,
  ...
  scale_color_brewer(type = "qual", palette = "Set2") # ggthemes agrega mas colores como colorblind 
...
my_colors <- c("#ED6D37", "#901C6C", "#18A5C5", "#A6CE8F") # creacion del objeto para usarlo despues
...
ggplot(data = global_waste_data_kg_year,
  ...
  # https://scales.r-lib.org/reference/label_log.html lm linear module, se standar error excluded. 
...
ggplot(data = global_waste_data_kg_year,
  ...
  geom_smooth(method = "lm", 
              ...
              color = "gray20", 
              linetype = "longdash") +
  geom_label(data = global_waste_data_kg_year_filter, #labels de antes
